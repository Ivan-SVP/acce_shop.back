    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_price', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Цена поставщика')),
                ('price', models.DecimalField(decimal_places=2, max_digits=6, verbose_name='Розничная цена')),
